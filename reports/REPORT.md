...
Họ tên: **Lê Danh Trung**   Nhóm: **G04**   Ngày: **16/09/2026**
...
| --- | ---: | ---: | ---: | --- |
| `left_ear` | 66% | 45% | 21 điểm phần trăm | Hai bên chưa áp dụng hoàn toàn giống nhau tiêu chí phân biệt tai bị che `v=1` với tai nhìn thấy trực tiếp `v=2`. Bảng đếm chưa đủ để kết luận một bên gán sai. |
| `right_knee` | 28% | 14% | 14 điểm phần trăm | Hai bên có cách xử lý khác nhau đối với đầu gối không nhìn thấy trực tiếp nhưng vẫn còn trong khung; cần dùng phần đùi, cẳng chân và mép ảnh để phân biệt `v=1` với `v=0`. |
